    ...
    <div className={`beau-subpage-container theme-arena active-sec-${activeSection}`}>
      ...
      <section className="beau-hero">
        ...
        <div className="container beau-hero-inner" data-reveal>
          <span className="beau-hero-brand" style={{ backgroundColor: '#e8741e', color: '#ffffff' }}>
        ...
        <div className="container" data-reveal>
          ...
          <div className="beau-split-grid">
            ...
            <div className="beau-split-left">
              <div className="beau-sticky-label" style={{ color: '#e8741e', opacity: 0.15 }}>AMSP</div>
            ...
            <div className="beau-split-right">
              ...
              <div className="beau-sem-card" data-reveal data-reveal-delay="0.1">
                <span className="sem-num" style={{ color: '#e8741e' }}>Học Kỳ 01</span>
              ...
              {/* Semester 2 */}
              <div className="beau-sem-card" data-reveal data-reveal-delay="0.1">
                <span className="sem-num" style={{ color: '#e8741e' }}>Học Kỳ 02</span>
              ...
              {/* Semester 3 */}
              <div className="beau-sem-card" data-reveal data-reveal-delay="0.1">
                <span className="sem-num" style={{ color: '#e8741e' }}>Học Kỳ 03</span>
              ...
              {/* Semester 4 */}
              <div className="beau-sem-card" data-reveal data-reveal-delay="0.1">
                <span className="sem-num" style={{ color: '#e8741e' }}>Học Kỳ 04</span>
      ...
      <section className="beau-section beau-full-viewport">
        <div className="container" data-reveal>
          ...
          <div className="beau-careers-grid">
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.05">
            ...
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.1">
            ...
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.15">
            ...
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.2">
            ...
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.25">
            ...
            <div className="beau-career-card" style={{ borderLeftColor: '#e8741e' }} data-reveal data-reveal-delay="0.3">
      ...
      <section className="beau-section beau-full-viewport">
        <div className="container" data-reveal>
          ...
          <div className="beau-incentives-grid">
            <div className="beau-incentive-card" style={{ '--accent': '#e8741e' }} data-reveal data-reveal-delay="0.05">
            ...
            <div className="beau-incentive-card" style={{ '--accent': '#e8741e' }} data-reveal data-reveal-delay="0.1">
            ...
            <div className="beau-incentive-card" style={{ '--accent': '#e8741e' }} data-reveal data-reveal-delay="0.15">
