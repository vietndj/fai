            ...
            <div style={{ marginTop: '22px' }}>
              ...
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
                {[
                  ...
                  { name: 'Zalo', url: 'https://zalo.me/3164559225263453576', icon: <svg width="18" height="18" viewBox="0 0 48 48" fill="currentColor"><path d="M24 4C12.954 4 4 12.954 4 24c0 3.957 1.147 7.649 3.125 10.771L4.5 43.5l8.729-2.625C16.351 42.853 20.043 44 24 44c11.046 0 20-8.954 20-20S35.046 4 24 4zm5.5 27h-11c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5h7.293l-8.439-8.439c-.582-.582-.215-1.561.797-1.561H28.5c.828 0 1.5.672 1.5 1.5s-.672 1.5-1.5 1.5h-7.293l8.439 8.439c.582.582.215 1.561-.797 1.561z"/></svg> },
                  ...
                  { name: 'Threads', url: 'https://www.threads.com/@fptacademyinternational', icon: <svg width="18" height="18" viewBox="0 0 192 192" fill="currentColor"><path d="M141.537 88.9883C140.71 88.5919 139.87 88.2104 139.019 87.8451C137.537 60.5382 122.616 44.005 97.58 44.005C72.1895 44.005 52.8807 62.6902 52.8807 95.8369C52.8807 128.984 72.1895 147.669 97.58 147.669C114.777 147.669 128.47 139.117 135.534 125.132C138.835 125.688 141.97 126.155 144.975 126.549C136.216 146.046 118.665 158.455 97.58 158.455C65.5786 158.455 41.5 133.518 41.5 95.8369C41.5 58.1561 65.5786 33.2188 97.58 33.2188C130.221 33.2188 148.91 54.4984 150.323 88.2104C150.347 88.7844 150.36 89.3626 150.36 89.9449C150.36 116.31 138.995 133.484 119.539 133.484C108.859 133.484 100.957 126.377 100.957 114.159C100.957 112.87 101.077 111.536 101.316 110.158C103.585 97.0514 107.962 86.8124 114.448 79.44C111.444 76.5907 106.843 74.8879 101.272 74.8879C90.2319 74.8879 81.9863 83.187 81.9863 94.6198C81.9863 105.77 89.4756 113.882 100.117 113.882C99.2882 118.657 96.6111 122.697 90.957 122.697C82.8856 122.697 78.4727 113.253 78.4727 95.8369C78.4727 77.2917 88.9248 68.6186 97.58 68.6186C105.214 68.6186 112.44 74.1956 114.07 83.0768C117.842 81.4283 121.849 80.5752 126.091 80.5752C130.82 80.5752 135.298 81.651 139.525 83.8026C141.537 88.9883 141.537 88.9883 141.537 88.9883Z"/></svg> }
                ].map((s, idx) => (
                  <a
                    key={idx}
                    href={s.url}
